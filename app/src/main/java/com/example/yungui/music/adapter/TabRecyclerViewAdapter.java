...
public class TabRecyclerViewAdapter extends BaseQuickAdapter<MusicInfo, BaseViewHolder> {

    public TabRecyclerViewAdapter(int layoutResId, @Nullable List<MusicInfo> data) {
